module.exports = {
  ...
  'en-EN': {
    ...
    billingRepresentativeAdded: 'Billing representative added.',
    billingRepresentativeRemoved: 'Billing representative removed.',
    billingRepresentativeAlreadyAdded: 'Billing representative already added.',
    ...
    courseDeletionForbidden: {
      ...
      trainerMissions: 'Deletion forbidden : course has trainer missions.',
    },
    ...
    courseTrainerRolesUpdated: 'Course trainer role(s) updated.',
    ...
    courseBillingItemAlreadyAddedToCourse: 'Course billing item already added to course.',
    ...
    slotIsLinkedToTrainerBill: 'Operation forbidden : slot is paid and linked to a trainerBill.',
    /* Questionnaires */
    ...
    incorrectEmailForOperationsRepresentative: 'email is incorrect for operations representative',
    incorrectEmailForSalesRepresentative: 'email is incorrect for sales representative',
    incorrectEmailForCoach: 'email is incorrect for coach',
    incorrectEmailForArchitect: 'email is incorrect for architect',
    ...
    missingSubProgram: 'subProgram is missing',
    unknownSubProgram: 'subProgram doesn\'t exist',
    missingOperationsRepresentative: 'operations representative is missing',
    unknownOperationsRepresentative: 'operations representative doesn\'t exist',
    unknownCoach: 'coach doesn\'t exist',
    unknownArchitect: 'architect doesn\'t exist',
    coachAndArchitectAreSame: 'coach and architect must be different people',
    incorrectDate: 'date is incorrect',
    unknownStep: 'step doesn\'t exist',
    courseSlotElearningStepCsv: 'no slot allowed on an e-learning step',
    courseSlotDatesNotSameDay: 'start and end date must be on the same day',
    courseSlotStartAfterEndCsv: 'start date must be before end date',
    addressNotAllowedForStepType: 'address is not allowed for this step type',
    meetingLinkNotAllowedForStepType: 'meeting link is not allowed for this step type',
    addressAndMeetingLinkBothSet: 'address and meeting link can\'t be both set',
    unknownAddress: 'address could not be found',
    missingTrainersCsv: 'trainers is missing',
    incorrectTrainerEmail: 'trainer email is incorrect',
    unknownTrainer: 'trainer doesn\'t exist',
    trainerNotInCourse: 'trainer is not linked to this course',
    trainerRoleMismatchCsv: 'trainer\'s role does not match any allowed role for this step',
    incorrectTraineeEmail: 'trainee email is incorrect',
    unknownTraineeCsv: 'trainee doesn\'t exist',
    traineeNotInCourse: 'trainee is not registered to this course',
    courseSlotConflictCsv: 'course slot is in conflict with another one',
    missingTradeName: 'trade name is missing',
    fileIsToBig: 'File is too big.',
    missingCourseType: 'type is missing',
    invalidCourseType: 'course type is invalid',
    missingHolding: 'holding is missing',
    unknownHolding: 'holding doesn\'t exist',
    unknownSalesRepresentative: 'sales representative doesn\'t exist',
    missingCertificateGenerationMode: 'certificate generation mode is missing',
  ...
  'fr-FR': {
    ...
    billingRepresentativeAdded: 'Chargé de facturation ajouté.',
    billingRepresentativeRemoved: 'Chargé de facturation supprimé.',
    billingRepresentativeAlreadyAdded: 'Chargé de facturation déjà ajouté.',
    ...
    subProgramInconsistentPriceRoles: 'Impossible : les tarifs d\'une étape doivent soit tous avoir un rôle, soit '
      + 'aucun.',
    ...
    courseDeletionForbidden: {
      ...
      trainerMissions: 'Suppression impossible : la formation est reliée à un ordre de mission.',
    },
    ...
    courseTrainerRolesUpdated: 'Rôle(s) de l\'intervenant(e) mis à jour.',
    ...
    courseBillingItemAlreadyAddedToCourse: 'Coût déjà ajouté à la formation.',
    ...
    attendanceUpdated: 'Émargement modifié.',
    ...
    slotIsLinkedToTrainerBill: 'Opération impossible : le créneau est réglé et relié à une facture d\'un intervenant.',
    /* Questionnaires */
    ...
    incorrectEmailForOperationsRepresentative: 'le format de l\'email est incorrect pour le chargé des opérations',
    incorrectEmailForSalesRepresentative: 'le format de l\'email est incorrect pour le chargé d\'accompagnement',
    incorrectEmailForCoach: 'le format de l\'email est incorrect pour le coach',
    incorrectEmailForArchitect: 'le format de l\'email est incorrect pour l\'architecte',
    ...
    missingSubProgram: 'le sous-programme est manquant',
    unknownSubProgram: 'le sous-programme n\'existe pas',
    missingOperationsRepresentative: 'le chargé des opérations est manquant',
    ...
    coachAndArchitectAreSame: 'le coach et l\'architecte doivent être des personnes différentes',
    incorrectDate: 'le format de la date est incorrect',
    unknownStep: 'l\'étape n\'existe pas',
    courseSlotElearningStepCsv: 'aucun créneau possible sur une étape eLearning',
    courseSlotDatesNotSameDay: 'les dates de début et de fin doivent être le même jour',
    courseSlotStartAfterEndCsv: 'la date de début doit précéder la date de fin',
    addressNotAllowedForStepType: 'l\'adresse n\'est pas autorisée pour ce type d\'étape',
    meetingLinkNotAllowedForStepType: 'le lien visio n\'est pas autorisé pour ce type d\'étape',
    addressAndMeetingLinkBothSet: 'vous ne pouvez pas renseigner à la fois une adresse et un lien visio',
    unknownAddress: 'l\'adresse est introuvable',
    missingTrainersCsv: 'les intervenants sont manquants',
    incorrectTrainerEmail: 'l\'email de l\'intervenant est incorrect',
    unknownTrainer: 'l\'intervenant n\'existe pas',
    trainerNotInCourse: 'l\'intervenant n\'est pas rattaché à cette formation',
    trainerRoleMismatchCsv: 'le rôle de l\'intervenant n\'est pas autorisé sur cette étape',
    incorrectTraineeEmail: 'l\'email de l\'apprenant est incorrect',
    unknownTraineeCsv: 'l\'apprenant n\'existe pas',
    traineeNotInCourse: 'l\'apprenant n\'est pas inscrit à cette formation',
    courseSlotConflictCsv: 'le créneau est en conflit avec un autre créneau',
    missingTradeName: 'le nom commercial est manquant',
    fileIsToBig: `Le fichier contient trop d'éléments (${process.env.MAX_CSV_COURSE_SIZE} maximum).`,
    missingCourseType: 'le type est manquant',
    invalidCourseType: 'le type de formation est invalide',
    missingHolding: 'la société mère est manquante',
    unknownHolding: 'la société mère n\'existe pas',
    unknownSalesRepresentative: 'le chargé d\'accompagnement n\'existe pas',
    missingCertificateGenerationMode: 'le mode de génération des attestations est manquant',
