...
const rights = [
  ...
  { permission: 'completioncertificates:read', rolesConcerned: [VENDOR_ADMIN, TRAINING_ORGANISATION_MANAGER, CLIENT_ADMIN, COACH], description: 'Afficher les certificats de réalisation mensuels' },
