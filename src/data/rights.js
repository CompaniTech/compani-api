...
const rights = [
  ...
  { permission: 'trainerinvoices:edit', rolesConcerned: [VENDOR_ADMIN, TRAINING_ORGANISATION_MANAGER], description: 'Modifier le statut d\'une facture d\'intervenant·e' },
