...
const rights = [
  ...
  { permission: 'trainerbills:create', rolesConcerned: [VENDOR_ADMIN, TRAINING_ORGANISATION_MANAGER, TRAINER], description: 'Facturer des créneaux de formation' },
  { permission: 'trainerbills:edit', rolesConcerned: [VENDOR_ADMIN, TRAINING_ORGANISATION_MANAGER], description: 'Modifier et supprimer une facture d\'intervenant·e' },
