...
const rights = [
  ...
  { permission: 'completioncertificates:edit', rolesConcerned: [VENDOR_ADMIN, TRAINING_ORGANISATION_MANAGER], description: 'Générer et télécharger les certificats de réalisation mensuels' },
  { permission: 'completioncertificates:create', rolesConcerned: [VENDOR_ADMIN, TRAINING_ORGANISATION_MANAGER], description: 'Créer un certificat' },
