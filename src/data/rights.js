...
const rights = [
  ...
  { permission: 'courseslots:read', rolesConcerned: [VENDOR_ADMIN, TRAINING_ORGANISATION_MANAGER, TRAINER], description: 'Récupérer des créneaux' },
  ...
  { permission: 'programs:edit', rolesConcerned: [VENDOR_ADMIN, TRAINING_ORGANISATION_MANAGER, TRAINER], description: 'Editer les programmes' },
  { permission: 'programs:read', rolesConcerned: [VENDOR_ADMIN, TRAINING_ORGANISATION_MANAGER, TRAINER], description: 'Consulter les données des programmes' },
  ...
  { permission: 'scripts:run', rolesConcerned: [VENDOR_ADMIN], description: 'Lancer un script' },
  ...
  { permission: 'trainerinvoices:create', rolesConcerned: [VENDOR_ADMIN, TRAINING_ORGANISATION_MANAGER, TRAINER], description: 'Facturer des créneaux de formation' },
  { permission: 'trainerinvoices:edit', rolesConcerned: [VENDOR_ADMIN, TRAINING_ORGANISATION_MANAGER], description: 'Modifier et supprimer une facture d\'intervenant·e' },
