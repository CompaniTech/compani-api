...
describe('upload', () => {
  ...
  it('should create a trainer mission for a single course', async () => {
    ...
    const payload = { courses: { _id: courseId, fee: 1200 }, file: 'test.pdf', trainer: trainerId };
  ...
  it('should create a trainer mission for several courses', async () => {
    ...
    const courses = [{ _id: courseIds[0], fee: 500 }, { _id: courseIds[1] }];
...
describe('list', () => {
  ...
  it('should return trainer missions', async () => {
    ...
    const trainerMissions = [{
      ...
      courses: [
        { _id: new ObjectId(), subProgram: { program: { name: 'name' } }, companies: [{ name: 'Alenvi' }], fee: 12 },
      ],
      fee: 12,
...
describe('generate', () => {
  ...
  it('should generate a trainer mission for a single course', async () => {
    ...
    const payload = { courses: { _id: courseId, fee: 1200 }, trainer: trainerId };
  ...
  it('should generate a trainer mission for several courses', async () => {
    ...
    const missionCourses = [{ _id: courseIds[0], fee: 500 }, { _id: courseIds[1], fee: 700 }];
