...
describe('getOfficialPdfContent', () => {
  ...
  it('shoult format and return official pdf content for PRI courses', async () => {
    const data = {
    ...
    const checkBoxSection = [
      ...
      { canvas: [{ type: 'rect', x: 0, y: 0, w: 8, h: 8, r: 0 }], absolutePosition: { x: 59, y: 398 } },
      {
        text: [
          { text: '√', position: { x: 59, y: 398 }, marginRight: 4 },
          { text: [{ text: ' action de Période de Reconversion Interne' }, { text: ' 1', fontSize: 8, bold: true }] },
        ],
        marginBottom: 4,
        marginLeft: 20,
      },
  ...
  it('should format and return official pdf content for VAEI courses in VAE period (only VAE hours)', async () => {
    const data = {
      programName: 'Programme',
      startDate: '01/02/2025',
      endDate: '28/02/2025',
      ...
      isPRISubProgram: false,
      certificateGenerationModeIsMonthly: true,
      vaeSupportData: { vaeDuration: '4h30', regularDuration: null },
    };
  ...
  it('should format and return official pdf content for VAEI courses in VAE period (mixed regular and VAE hours)',
    async () => {
      const data = {
        programName: 'Programme',
        startDate: '01/02/2025',
        ...
        isPRISubProgram: false,
        certificateGenerationModeIsMonthly: true,
        vaeSupportData: { vaeDuration: '4h', regularDuration: '6h' },
      };
      ...
      const footer = [
        ...
        },
        {
          text: [
            ...
            { text: '2 ', fontSize: 8 },
            {
              text: 'Dans le cadre des formations à distance prendre en compte la réalisation des activités'
