...
describe('getPdfContent', () => {
  ...
  it('it should format and return paid course bill pdf (with billing items and percentage)', async () => {
    ...
    const bill = {
      ...
      companies: [{ _id: companyId, name: 'Test structure' }],
      payer: {
        name: 'payeur',
        address: '24 Avenue Daumesnil 75012 Paris',
      },
    ...
    formatPrice.onCall(10).returns('1300,00 €');
    formatPrice.onCall(11).returns('0,00 €');
    formatPrice.onCall(12).returns('123 000,00 €');
