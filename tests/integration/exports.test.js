...
const vendorHistoryExportTypes = [
  {
    ...
    expectedRows: [
      ...
      `${coursesList[1]._id};"Inter B2B";"APA Paris";"Test SAS,Un autre SAS";;"Program 2";"subProgram 2";;"Gilles FORMATEUR";"01/02/2021";;"Aline CONTACT-COM";"Aline CONTACT-COM";2;2;2;1;"4,00";1;0;"0,67";1;1;"01/01/2019";"24/10/2018";0;2;2;1;2;"0,67";"Non";;"2 sur 2";"Oui";"800,00";"300,00";"-500,00";"07/01/2018"`,
      `${coursesList[2]._id};"Inter B2B";;"Test SAS,Test SAS withtout subscription,Un autre SAS";;"Program 2";"subProgram 2";"group 3";"Gilles FORMATEUR";;;"Aline CONTACT-COM";"Aline CONTACT-COM";3;0;0;0;"0,00";0;0;"0,44";0;1;"12/01/2022";"12/01/2022";0;0;0;0;0;;"Non";;"0 sur 3";"Non";;;;"07/01/2018"`,
      `${coursesList[7]._id};"Intra société mère";;;"Société mère";"Program 1";"subProgram 1";"group 8";"Gilles FORMATEUR";"16/01/2021";"16/01/2021";"Aline CONTACT-COM";"Aline CONTACT-COM";0;1;1;0;"2,00";0;0;"0,00";0;0;;;0;0;0;0;0;"1,00";"Non";;"0 sur 0";"Non";;;;"07/01/2018"`,
      ...
      `${coursesList[9]._id};"Individuelle";;"Un autre SAS";;"Program 1";"subProgram 1";"single";"Gilles FORMATEUR";"01/05/2021";"01/05/2021";"Aline CONTACT-COM";"Aline CONTACT-COM";1;1;1;0;"2,00";0;1;"0,00";0;0;;;0;0;1;0;0;"1,00";"Non";;"0 sur 1";"Non";;;;"07/01/2018"`,
    ],
  ...
  },
  {
    ...
    expectedRows: [
      ...
      `${courseSlotList[12]._id};${coursesList[9]._id};"Program 1 - single";"étape 2";"distanciel";"12/12/2020 11:00:01";"01/05/2021 16:00:00";"01/05/2021 18:00:00";"2,00";"https://meet.google.com";0;1;0`,
    ],
  ...
  },
  {
    ...
    expectedRows: [
      '\ufeff"Nature";"Identifiant";"Date";"Id formation";"Formation";"Programme";"Structure";"Id payeur";"Payeur";"Montant TTC";"Montant réglé";"Document lié";"Montant soldé";"Solde";"Avancement";"Début de la formation";"Milieu de la formation";"Fin de la formation"',
      `"Facture";"FACT-00001";"08/03/2022";${coursesList[0]._id};"Test SAS - Program 1 - group 1";"Program 1";"Test SAS";${courseFundingOrganisation._id};"APA Paris";"1200,00";"1150,00";;;"-50,00";"1,00";"01/05/2021";"01/05/2021";"01/05/2021"`,
      ...
      `"Facture";"FACT-00005";"08/03/2022";${coursesList[1]._id};"Program 2";"Program 2";"Un autre SAS";${courseFundingOrganisation._id};"APA Paris";"400,00";"-100,00";;;"-500,00";"0,67";"01/02/2021";"02/02/2021";`,
