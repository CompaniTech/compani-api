...
const vendorHistoryExportTypes = [
  {
    ...
    expectedRows: [
      ...
      `${coursesList[0]._id};"Intra";"Test SAS";"Test SAS";"Auth Holding";"Nom 1";"Program 1";${programList[0]._id};"subProgram 1";"group 1";"Gilles FORMATEUR, Simon TRAINERANDCOACH";"01/05/2021";"01/05/2021";"Aline CONTACT-COM";"Aline CONTACT-COM";3;1;2;0;"4,00";2;1;"0,00";2;1;;;1;2;1;3;0;0;"1,00";"Oui";"08/07/2024";"${formatPrice(coursesList[0].prices[0].global)}";"1 sur 1";"Oui";"1200,00";"0,00";"-1200,00";"07/01/2018"`,
      `${coursesList[5]._id};"Intra";"APA Paris,Test SAS";"Test SAS";"Auth Holding";"Nom 1";"Program 1";${programList[0]._id};"subProgram 1";"group 6";"Gilles FORMATEUR";"12/04/2021";"12/04/2021";"Aline CONTACT-COM";"Aline CONTACT-COM";3;1;1;0;"2,00";0;1;"0,00";0;0;;;0;0;0;2;0;0;"1,00";"Non";;;"2 sur 3";"Non";"880,00";"0,00";"-880,00";"07/01/2018"`,
  ...
  },
  {
    ...
    expectedRows: [
      ...
      `"Facture";"FACT-00001";"08/03/2022";${coursesList[0]._id};"Test SAS - Nom 1 - group 1";"Program 1";;"Test SAS";${authCompany._id};"Test SAS";"Oui";"20/07/2025";"1200,00";"0,00";"Prélèvements Septembre 2025";;;"-1200,00";"08/05/2022, 08/06/2022";"1,00";"01/05/2021";"01/05/2021";"01/05/2021"`,
      `"Facture";"FACT-00002";"08/03/2022";${coursesList[3]._id};"Test SAS - Nom 1 - group 4";"Program 1";;"Test SAS";${courseFundingOrganisation._id};"APA Paris";"Non";;"1200,00";"0,00";;"AV-00001";"1200,00";"0,00";"08/05/2022";"1,00";"01/02/2021";"03/02/2021";"10/02/2021"`,
      `"Facture";"FACT-00005";"08/03/2022";${coursesList[1]._id};"Nom 2";"Program 2";;"Un autre SAS";${courseFundingOrganisation._id};"APA Paris";"Non";;"400,00";"100,00";;;;"-300,00";;"0,67";"01/02/2021";"02/02/2021";`,
      `"Avoir";"AV-00002";"09/03/2022";${coursesList[5]._id};"Test SAS - Nom 1 - group 6";"Program 1";;"Test SAS";${authCompany._id};"Test SAS";"Oui";"20/07/2025";"240,00";;;"FACT-00008";;;;;;;`,
    ],
