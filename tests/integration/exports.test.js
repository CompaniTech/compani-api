...
const vendorHistoryExportTypes = [
  {
    ...
    expectedRows: [
      ...
      `${coursesList[0]._id};"Intra";"Test SAS";"Test SAS";"Auth Holding";"Nom 1";"Program 1";${programList[0]._id};"subProgram 1";"group 1";"Gilles FORMATEUR, Simon TRAINERANDCOACH";"01/05/2021";"01/05/2021";"Aline CONTACT-COM";"Aline CONTACT-COM";3;1;2;0;"4,00";2;1;"0,00";2;1;;;1;2;1;3;0;0;"1,00";"Oui";"08/07/2024";"${formatPrice(coursesList[0].prices[0].global)}";"1 sur 1";"Oui";"1200,00";"1320,00";"0,00";"-1320,00";"07/01/2018"`,
      `${coursesList[5]._id};"Intra";"APA Paris,Test SAS";"Test SAS";"Auth Holding";"Nom 1";"Program 1";${programList[0]._id};"subProgram 1";"group 6";"Gilles FORMATEUR";"12/04/2021";"12/04/2021";"Aline CONTACT-COM";"Aline CONTACT-COM";3;1;1;0;"2,00";0;1;"0,00";0;0;;;0;0;0;2;0;0;"1,00";"Non";;;"2 sur 3";"Non";"880,00";"880,00";"0,00";"-880,00";"07/01/2018"`,
      `${coursesList[6]._id};"Intra";;"Test SAS";"Auth Holding";"Nom 1";"Program 1";${programList[0]._id};"subProgram 1";"group 7";"Gilles FORMATEUR";"12/04/2021";"12/04/2021";"Aline CONTACT-COM";"Aline CONTACT-COM";0;1;1;0;"2,00";0;0;"0,00";0;0;;;0;0;0;0;0;0;"1,00";"Non";;;"0 sur 0";"Non";;;;;"07/01/2018"`,
      `${coursesList[1]._id};"Inter B2B";"APA Paris";"Test SAS,Un autre SAS";"Auth Holding, Other Holding";"Nom 2";"Program 2";${programList[1]._id};"subProgram 2";;"Gilles FORMATEUR";"01/02/2021";;"Aline CONTACT-COM";"Aline CONTACT-COM";2;2;2;1;"4,00";1;0;"0,67";1;1;"01/01/2019";"24/10/2018";0;2;0;2;1;2;"0,67";"Non";;"\nTest SAS: ${formatPrice(coursesList[1].prices[0].global)} (+ FF: ${formatPrice(coursesList[1].prices[0].trainerFees)})\nUn autre SAS: ${formatPrice(coursesList[1].prices[1].global)}";"2 sur 2";"Oui";"800,00";"800,00";"500,00";"-300,00";"07/01/2018"`,
      ...
      `${coursesList[7]._id};"Intra société mère";;;"Société mère";"Nom 1";"Program 1";${programList[0]._id};"subProgram 1";"group 8";"Gilles FORMATEUR";"16/01/2021";"16/01/2021";"Aline CONTACT-COM";"Aline CONTACT-COM";0;1;1;0;"2,00";0;0;"0,00";0;0;;;0;0;0;0;0;0;"1,00";"Non";;;"0 sur 0";"Non";;;;;"07/01/2018"`,
      `${coursesList[3]._id};"Intra";;"Test SAS";"Auth Holding";"Nom 1";"Program 1";${programList[0]._id};"subProgram 1";"group 4";"Gilles FORMATEUR";"01/02/2021";"10/02/2021";"Aline CONTACT-COM";"Aline CONTACT-COM";2;3;3;0;"11,00";0;1;"0,00";0;1;;;0;0;0;6;0;0;"1,00";"Non";;;"0 sur 1";"Non";;;;;"07/01/2018"`,
      `${coursesList[8]._id};"Intra";;"Un autre SAS";"Other Holding";"Nom 1";"Program 1";${programList[0]._id};"subProgram 1";"group 9";"Gilles FORMATEUR";"01/05/2021";"01/05/2021";"Aline CONTACT-COM";"Aline CONTACT-COM";1;1;1;0;"2,00";0;1;"0,00";0;1;;;0;1;0;0;0;0;"1,00";"Non";;;"0 sur 1";"Non";;;;;"07/01/2018"`,
    ],
