...
const vendorHistoryExportTypes = [
  ...
  },
  {
    ...
    expectedRows: [
      ...
      `${courseSlotList[0]._id};${coursesList[0]._id};"Test SAS - Program 1 - group 1";"étape 1";"présentiel";"12/12/2020 11:00:00";"01/05/2021 10:00:00";"01/05/2021 12:00:00";"2,00";"24 Avenue Daumesnil 75012 Paris";1;1;"2,00";0;1;0;"Gilles FORMATEUR, Simon TRAINERANDCOACH";"Payé"`,
      `${courseSlotList[1]._id};${coursesList[0]._id};"Test SAS - Program 1 - group 1";"étape 2";"distanciel";"12/12/2020 11:00:01";"01/05/2021 16:00:00";"01/05/2021 18:00:00";"2,00";"https://meet.google.com";1;0;"0,00";0;2;0;"Gilles FORMATEUR, Simon TRAINERANDCOACH";"Payé"`,
      `${courseSlotList[2]._id};${coursesList[1]._id};"Program 2";"étape 1";"présentiel";"12/12/2020 11:00:02";"01/02/2021 09:00:00";"01/02/2021 11:00:00";"2,00";"24 Avenue Daumesnil 75012 Paris";1;0;"0,00";1;1;0;"Gilles FORMATEUR";"Payé"`,
      `${courseSlotList[3]._id};${coursesList[1]._id};"Program 2";"étape 3";"eLearning";"12/12/2020 11:00:03";"02/02/2021 09:00:00";"02/02/2021 11:00:00";"2,00";;1;0;"0,00";1;1;0;"Gilles FORMATEUR";"Payé"`,
      `${courseSlotList[5]._id};${coursesList[5]._id};"Test SAS - Program 1 - group 6";"étape 1";"présentiel";"12/12/2020 11:00:04";"12/04/2021 12:00:00";"12/04/2021 14:00:00";"2,00";"24 Avenue Daumesnil 75012 Paris";0;0;"0,00";0;2;1;"Gilles FORMATEUR";"Payé"`,
      `${courseSlotList[6]._id};${coursesList[6]._id};"Test SAS - Program 1 - group 7";"étape 1";"présentiel";"12/12/2020 11:00:04";"12/04/2021 12:00:00";"12/04/2021 14:00:00";"2,00";"24 Avenue Daumesnil 75012 Paris";0;0;"0,00";0;0;0;"Gilles FORMATEUR";"Payé"`,
      `${courseSlotList[8]._id};${coursesList[3]._id};"Test SAS - Program 1 - group 4";"étape 1";"présentiel";"14/10/2020 23:00:00";"01/02/2021 10:00:00";"01/02/2021 13:00:00";"3,00";"24 Avenue Daumesnil 75012 Paris";0;0;"0,00";0;2;0;"Gilles FORMATEUR";"Payé"`,
      `${courseSlotList[9]._id};${coursesList[3]._id};"Test SAS - Program 1 - group 4";"étape 2";"distanciel";"14/10/2020 23:00:10";"10/02/2021 09:00:00";"10/02/2021 13:00:00";"4,00";;0;0;"0,00";0;2;0;"Gilles FORMATEUR";"Payé"`,
      `${courseSlotList[10]._id};${coursesList[3]._id};"Test SAS - Program 1 - group 4";"étape 1";"présentiel";"14/10/2020 23:00:30";"03/02/2021 09:00:00";"03/02/2021 13:00:00";"4,00";"24 Avenue Daumesnil 75012 Paris";0;0;"0,00";0;2;0;"Gilles FORMATEUR";"Payé"`,
      `${courseSlotList[11]._id};${coursesList[8]._id};"Un autre SAS - Program 1 - group 9";"étape 2";"distanciel";"12/12/2020 11:00:01";"01/05/2021 16:00:00";"01/05/2021 18:00:00";"2,00";"https://meet.google.com";1;0;"0,00";0;0;0;"Gilles FORMATEUR";"Non payé"`,
    ],
  ...
  },
  {
    ...
    expectedRows: [
      ...
      `${courseSlotList[12]._id};${coursesList[9]._id};"Program 1 - Paul Trainee";"étape 2";"distanciel";"Paul TRAINEE";"12/12/2020 11:00:01";"01/05/2021 16:00:00";"01/05/2021 18:00:00";"2,00";"https://meet.google.com";0;0;"0,00";0;1;"Gilles FORMATEUR";"Payé"`,
      `${courseSlotList[13]._id};${coursesList[10]._id};"Program 1 - Marie Trainee";"étape 2";"distanciel";"Marie TRAINEE";"12/12/2020 11:00:01";"17/01/2021 15:00:00";"17/01/2021 19:00:00";"4,00";"https://meet.google.com";1;0;"0,00";0;0;"Gilles FORMATEUR";"Non payé"`,
    ],
