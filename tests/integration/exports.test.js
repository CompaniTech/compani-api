...
const vendorHistoryExportTypes = [
  ...
  },
  {
    ...
    expectedRows: [
      '\ufeff"Id Créneau";"Id Formation";"Formation";"Étape";"Type";"Date de création";"Date de début";"Date de fin";"Durée";"Adresse";"Nombre de présences";"Nombre d\'absences";"Durée absences";"Nombre de présences non prévues";"Nombre d\'émargements non remplis";"Nombre d\'apprenants non concernés";"Intervenants";"Statut";"Facture intervenant"',
      `${courseSlotList[0]._id};${coursesList[0]._id};"Test SAS - Program 1 - group 1";"étape 1";"présentiel";"12/12/2020 11:00:00";"01/05/2021 10:00:00";"01/05/2021 12:00:00";"2,00";"24 Avenue Daumesnil 75012 Paris";1;1;"2,00";0;1;0;"Gilles FORMATEUR, Simon TRAINERANDCOACH";"Gilles FORMATEUR : Réglé, Simon TRAINERANDCOACH : Non réglé";"Gilles FORMATEUR : FACT_0001"`,
      `${courseSlotList[1]._id};${coursesList[0]._id};"Test SAS - Program 1 - group 1";"étape 2";"distanciel";"12/12/2020 11:00:01";"01/05/2021 16:00:00";"01/05/2021 18:00:00";"2,00";"https://meet.google.com";1;0;"0,00";0;2;0;"Gilles FORMATEUR, Simon TRAINERANDCOACH";"Gilles FORMATEUR : Non réglé, Simon TRAINERANDCOACH : Réglé";"Simon TRAINERANDCOACH : FACT_01234"`,
      `${courseSlotList[2]._id};${coursesList[1]._id};"Program 2";"étape 1";"présentiel";"12/12/2020 11:00:02";"01/02/2021 09:00:00";"01/02/2021 11:00:00";"2,00";"24 Avenue Daumesnil 75012 Paris";1;0;"0,00";1;1;0;"Gilles FORMATEUR";"Réglé";"FACT_0002"`,
      `${courseSlotList[3]._id};${coursesList[1]._id};"Program 2";"étape 3";"eLearning";"12/12/2020 11:00:03";"02/02/2021 09:00:00";"02/02/2021 11:00:00";"2,00";;1;0;"0,00";1;1;0;"Gilles FORMATEUR";"Réglé";"FACT_0002"`,
      `${courseSlotList[5]._id};${coursesList[5]._id};"Test SAS - Program 1 - group 6";"étape 1";"présentiel";"12/12/2020 11:00:04";"12/04/2021 12:00:00";"12/04/2021 14:00:00";"2,00";"24 Avenue Daumesnil 75012 Paris";0;0;"0,00";0;2;1;"Gilles FORMATEUR";"Réglé";"FACT_0001"`,
      `${courseSlotList[6]._id};${coursesList[6]._id};"Test SAS - Program 1 - group 7";"étape 1";"présentiel";"12/12/2020 11:00:04";"12/04/2021 12:00:00";"12/04/2021 14:00:00";"2,00";"24 Avenue Daumesnil 75012 Paris";0;0;"0,00";0;0;0;"Gilles FORMATEUR";"Réglé";"FACT_0001"`,
  ...
  },
  {
    ...
    expectedRows: [
      '\ufeff"Id Créneau";"Id Formation";"Formation";"Étape";"Type";"Apprenant";"Date de création";"Date de début";"Date de fin";"Durée";"Adresse";"Nombre de présences";"Nombre d\'absences";"Durée absences";"Nombre de présences non prévues";"Nombre d\'émargements non remplis";"Intervenants";"Statut";"Facture intervenant"',
      `${courseSlotList[12]._id};${coursesList[9]._id};"Program 1 - Paul Trainee";"étape 2";"distanciel";"Paul TRAINEE";"12/12/2020 11:00:01";"01/05/2021 16:00:00";"01/05/2021 18:00:00";"2,00";"https://meet.google.com";0;0;"0,00";0;1;"Gilles FORMATEUR, Simon TRAINERANDCOACH";"Gilles FORMATEUR : Réglé, Simon TRAINERANDCOACH : Réglé";"Gilles FORMATEUR : FACT_00012, Simon TRAINERANDCOACH : FACT_234w"`,
