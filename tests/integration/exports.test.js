...
const vendorHistoryExportTypes = [
  {
    ...
    expectedRows: [
      ...
      `${coursesList[8]._id};"Intra";;"Un autre SAS";"Other Holding";"Nom 1";"Program 1";${programList[0]._id};"subProgram 1";"group 9";"Gilles FORMATEUR";"01/05/2021";"01/05/2021";"Aline CONTACT-COM";"Aline CONTACT-COM";1;1;1;0;"2,00";0;1;"0,00";0;1;;;0;1;0;0;0;0;"1,00";"Non";;"0,00";;0;1;"Non";;;;;;"0,00";"07/01/2018"`,
    ],
  ...
  },
  {
    ...
    expectedRows: [
      ...
      `${coursesList[9]._id};"Individuelle";;"Un autre SAS";"Other Holding";"Nom 1";"Program 1";${programList[0]._id};"subProgram 1";"Paul Trainee";"Gilles FORMATEUR";"01/05/2021";"01/05/2021";"Aline CONTACT-COM";"Aline CONTACT-COM";1;1;1;0;"2,00";0;1;"0,00";0;0;;;0;0;0;1;0;0;"1,00";"Non";;"0,00";;0;1;"Non";"300,00";;;;;"07/01/2018"`,
      `${coursesList[10]._id};"Individuelle";;"Test SAS";"Auth Holding";"Nom 1";"Program 1";${programList[0]._id};"subProgram 1";"Marie Trainee";"Gilles FORMATEUR";"17/01/2021";"17/01/2021";"Aline CONTACT-COM";"Aline CONTACT-COM";1;1;1;0;"4,00";0;0;"0,00";0;0;;;0;1;0;0;0;0;"1,00";"Non";;"0,00";;0;1;"Non";;;;;;"07/01/2018"`,
    ],
    query: 'startDate=2021-01-15T10:00:00.000Z&endDate=2022-01-20T10:00:00.000Z',
  },
  {
  ...
  },
  {
    ...
    expectedRows: [
      '\ufeff"Nature";"Identifiant";"Date";"Id formation";"Formation";"Programme";"Apprenant";"Structure";"Id payeur";"Payeur";"Coordonnées bancaires du payeur renseignées";"Date de signature de mandat du payeur";"Montant HT";"Montant TTC";"Montant réglé";"Lot de prélèvement";"Date du lot de prélèvement";"Document lié";"Montant soldé";"Solde";"Envoyé le";"Avancement";"Début de la formation";"Milieu de la formation";"Fin de la formation"',
      `"Facture";"FACT-00001";"08/03/2022";${coursesList[0]._id};"Test SAS - Nom 1 - group 1";"Program 1";;"Test SAS";${authCompany._id};"Test SAS";"Oui";"20/07/2025";"1200,00";"1320,00";"0,00";"Prélèvements Septembre 2025";"12/03/2022";;;"-1320,00";"08/05/2022, 08/06/2022";"1,00";"01/05/2021";"01/05/2021";"01/05/2021"`,
