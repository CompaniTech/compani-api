...
const vendorHistoryExportTypes = [
  {
    ...
    expectedRows: [
      ...
      `${coursesList[0]._id};"Intra";"Test SAS";"Test SAS";"Auth Holding";"Nom 1";"Program 1";${programList[0]._id};"subProgram 1";"group 1";"Gilles FORMATEUR, Simon TRAINERANDCOACH";"01/05/2021";"01/05/2021";"Aline CONTACT-COM";"Aline CONTACT-COM";3;1;2;0;"4,00";2;1;"0,00";2;1;;;1;2;1;3;0;0;"1,00";"Oui";"08/07/2024";"${formatPrice(coursesList[0].prices[0].global)}";"1 sur 1";"Oui";"1200,00";"1200,00";"0,00";"-1200,00";"07/01/2018"`,
  ...
  },
  {
    ...
    expectedRows: [
      ...
      `"Facture";"FACT-00001";"08/03/2022";${coursesList[0]._id};"Test SAS - Nom 1 - group 1";"Program 1";;"Test SAS";${authCompany._id};"Test SAS";"Oui";"20/07/2025";"1200,00";"1200,00";"0,00";"Prélèvements Septembre 2025";;;"-1200,00";"08/05/2022, 08/06/2022";"1,00";"01/05/2021";"01/05/2021";"01/05/2021"`,
